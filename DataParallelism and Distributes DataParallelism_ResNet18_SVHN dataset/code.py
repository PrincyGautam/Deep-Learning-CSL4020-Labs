# -*- coding: utf-8 -*-
"""B20BB051_Lab_Assignment_9.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1fV5Je5x7jpdIhPa_zyr-vRbTLBiJZGsG
...
tags:
  ...
  - Jupyter Notebooks
--- -->
# Distributed Training with Ignite on SVHN
"""
...
!python -c "from torchvision.datasets import SVHN; SVHN('svhn', download=True)"
...
def get_train_datasets(path):
    train_transform = Compose([Pad(4),
    ...
    train_ds = datasets.SVHN(
        root=path, download=False, transform=train_transform
    )

    return train_ds

def get_dataflow(config):
    train_dataset = get_train_datasets(config["data_path"])
